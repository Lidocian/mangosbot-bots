...
namespace ai
{
    namespace rogue
    {
        ...
        private:
            static Strategy* assa_dps(PlayerbotAI* ai) { return new AssassinationDpsRogueStrategy(ai); }
         static Strategy* combat_dps(PlayerbotAI* ai) { return new CombatDpsRogueStrategy(ai); }
         static Strategy* sub_dps(PlayerbotAI* ai) { return new SubtletyDpsRogueStrategy(ai); }
